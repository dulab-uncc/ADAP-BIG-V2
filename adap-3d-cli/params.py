...
source_path = "C:\\Users\\jerry\\Desktop\\ADAP-3D-V2\\mzml-img-blocks" #File path to the source of images used for object detection
txt_inference_path = "C:\\Users\\jerry\\Desktop\\ADAP-3D-V2\\yolov5\\runs\\detect\\exp12\\labels" #File path to inferred txt files containing bounding boxes
window_mz = 25
window_rt = 65
