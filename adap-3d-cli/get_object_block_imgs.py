...
def get_image_for_blocks(profile_file_mzML, RESULTS_PATH, window_mz=60, window_rt=300, timetoignoreL = 2, timetoignoreR = 20, debugimageversion = False):
    ...
    for time in range(30, len(scan_t)-100, window_rt*2):
